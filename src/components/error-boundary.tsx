...
> {
  ...
  initParticlesIfAvailable() {
    try {
      ...
      const particlesFn = win?.particlesJS as unknown as
        | ((id: string, cfg: unknown) => void)
        | undefined;
        ...
        particlesFn("particles-js", {
          particles: {
            ...
            size: {
              value: 140,
              random: false,
              anim: { enable: true, speed: 10, size_min: 40 },
            },
      ...
      return (
        <div className="error-page-root" role="alert">
          ...
          <style jsx global>{`
            ...
            @keyframes eb-animateTextBackground {
              0% {
            ...
            .back {
              ...
              right: 40px;
              bottom: 40px;
              background: linear-gradient(135deg, #599692, #4a7d7a);
              border: none;
              border-radius: 8px;
              box-shadow: 0 4px 12px rgba(89, 150, 146, 0.3);
              color: #fff;
              font-size: 16px;
              font-weight: 700;
              line-height: 24px;
            ...
            .back:hover {
              box-shadow: 0 6px 20px rgba(89, 150, 146, 0.5);
              transform: translateY(-2px);
              background: linear-gradient(135deg, #4a7d7a, #599692);
            }
            .back:active {
              transform: translateY(0);
              box-shadow: 0 2px 8px rgba(89, 150, 146, 0.4);
            }
          `}</style>
        </div>
      );
