...
export const ScrollRevealSection = memo(function ScrollRevealSection({
  ...
  const content =
    isValidElement(children) && typeof children !== "string"
      ? cloneElement(
          children as React.ReactElement<{ parentContentVisible?: boolean }>,
          { parentContentVisible: visible }
        )
      : children;
...
(ScrollRevealSection as unknown as { displayName?: string }).displayName =
  "ScrollRevealSection";
