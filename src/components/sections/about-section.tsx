        ...
        >
          ...
          <m.div style={{ overflow: "hidden" }} className="max-w-2xl mx-auto">
            <m.p
              ...
              animate={
                contentCanAnimate
                  ? descriptionMotion.animate
                  : descriptionMotion.initial
              }
