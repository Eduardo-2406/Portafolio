...
export const SocialIcon = ({
  ...
  const getIcon = () => {
    switch (platform) {
      case "github":
        return (
          <svg
            className="w-full h-full text-foreground group-hover:text-primary transition-colors duration-300"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
      ...
      case "whatsapp":
        return (
          <WhatsAppIcon className="w-full h-full text-foreground group-hover:text-primary transition-colors duration-300" />
        );
      case "cv":
        return (
          <CVIcon className="w-full h-full text-foreground group-hover:text-primary transition-colors duration-300" />
        );
    }
  };
  ...
  if (variant === "about") {
    return (
      <m.div whileHover={{ y: -4, scale: 1.05 }} whileTap={{ scale: 0.95 }}>
        ...
        >
          <div className="w-5 h-5 flex-shrink-0">{getIcon()}</div>
          <span className="text-sm font-medium text-foreground group-hover:text-primary transition-colors duration-300 capitalize">
            {getName()}
          </span>
          <svg
            className="w-3.5 h-3.5 ml-auto text-muted-foreground group-hover:text-primary transition-all duration-300"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  return (
    ...
    >
      <div className="w-5 h-5 xl:w-6 xl:h-6 flex-shrink-0">{getIcon()}</div>
      ...
      <svg
        className="w-4 h-4 ml-auto text-muted-foreground group-hover:text-primary transition-all duration-300"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
